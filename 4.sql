...
--- Добавити стовпчик до таблиці Doctors
...
-- ЗАПОВНИТИ СТОВПЧИК ВИПАДКОВИМИ ЗНАЧЕННЯМИ (0-1000)
-- INSERT -- ДОБАВИТИ РЯДОК
-- UPDATE -- ЗМІНИ В  КОМІРКАХ ІСНУЮЧИХ СТОВПЧИКА

SELECT 1000*RANDOM();  -- ВИПАДКОВЕ ЧИСЛО ВІД 0 ДО 1000

UPDATE DOCTORS
SET PREMIUM = FLOOR(1000*RANDOM());
